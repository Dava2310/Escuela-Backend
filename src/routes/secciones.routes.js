...
// Ruta PATCH para actualizar una seccion
router.patch('/:seccionId',
    auth.ensureAuthenticated,
...
router.get('/:cursoId', 
    auth.ensureAuthenticated, 
    validate.validateAndConvertId('cursoId'), 
    ctrl.getSecciones
);

// Ruta GET para conseguir los estudiantes de un curso
router.get('/:seccionId/students', 
    auth.ensureAuthenticated, 
    validate.validateAndConvertId('seccionId'), 
    ctrl.getStudents
);
...
// Ruta GET para reprobar a un estudiante
